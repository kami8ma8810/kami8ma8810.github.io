...
var MomentumScroll = /*#__PURE__*/function () {
  ...
  _createClass(MomentumScroll, [{
    ...
    value: function render() {
      ...
      var nextY = this.translateY + (this.scrollY - this.translateY) * this.speed; // $('section').css({
      //   transform: 'skewY(' + (this.scrollY - this.translateY) / 480 + 'deg)',
      // });

      var containerChildren = document.querySelectorAll('.js-containerChild');
      containerChildren.forEach(function (containerChild) {
        containerChild.style.transform = 'skewY(' + (_this2.scrollY - _this2.translateY) / 480 + 'deg)';
      });
